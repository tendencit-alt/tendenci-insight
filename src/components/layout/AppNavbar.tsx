...
const ERP_MODULES: ModuleGroup[] = [
  {
    ...
    items: [
      { label: "CRM & Pipeline", route: "/crm-comercial", icon: "Target", available: true },
      { label: "Leads", route: "/leads", icon: "UserPlus", available: true },
      { label: "Orçamentos", route: "/propostas", icon: "FileText", available: false },
      ...
      { label: "Clientes", route: "/clientes", icon: "Users", available: true },
      { label: "Catálogo de Produtos", route: "/catalogo", icon: "BookOpen", available: true },
