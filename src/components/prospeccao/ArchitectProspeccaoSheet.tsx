...
export function ArchitectProspeccaoSheet({ 
  ...
  // Função para excluir parceiro profissional permanentemente
  const handleDeleteArchitect = async () => {
    ...
    try {
      ...
      if (error) {
        console.error('Erro ao excluir parceiro profissional:', error);
        ...
        if (error.message.includes('leads') || error.message.includes('deals') || 
          ...
          toast({
            ...
            description: "Este parceiro profissional possui registros vinculados (leads, negociações, pedidos ou projetos). Remova-os primeiro.",
            variant: "destructive",
          });
        } else {
          toast({
      ...
      toast({
        title: "Parceiro Profissional excluído",
        description: "O parceiro profissional foi removido permanentemente do sistema.",
      });
      ...
      toast({
        ...
        description: "Ocorreu um erro ao tentar excluir o parceiro profissional.",
        variant: "destructive",
      });
    } finally {
      setIsDeleting(false);
  ...
  // Buscar dados do parceiro profissional usando React Query
      ...
      <SheetContent className="sm:max-w-2xl overflow-y-auto">
                  ...
                  <AlertDialogContent>
                    <AlertDialogHeader>
                      <AlertDialogTitle className="flex items-center gap-2">
                        ...
                        Excluir Parceiro Profissional Permanentemente
                      </AlertDialogTitle>
        ...
        <Tabs defaultValue="info" className="mt-6">
          ...
          <TabsContent value="info" className="space-y-6">
              ...
              <div className="space-y-3 text-sm">
                <div>
                  ...
                  <Badge className="ml-2 bg-primary text-primary-foreground">
                    {architect.status_funil || "Novo Parceiro Profissional"}
                  </Badge>
                </div>
                <div>
            ...
            {/* Botão para abrir no módulo Parceiros Profissionais */}
            <Button variant="outline" className="w-full gap-2" asChild>
              <a href={`/architects`}>
                <ExternalLink className="h-4 w-4" />
                Abrir no Módulo Parceiros Profissionais
              </a>
            </Button>
          </TabsContent>
        ...
        <EditArchitectDialog
          ...
          onSuccess={() => {
            ...
            toast({
              title: "Sucesso",
              description: "Parceiro Profissional atualizado com sucesso!",
            });
          }}
        />
      </SheetContent>
