                      ...
                      {colRows.map((r) => {
                        const projectSlaTone =
                          r.slaOverdue > 0
                            ...
                            : "";
                        return (
                        <div key={r.id} className={`p-3 rounded-lg border bg-card text-card-foreground shadow-sm cursor-pointer hover:shadow-md transition ${projectSlaTone}`} onClick={() => openDetail(r.id.split('-')[0])}>
