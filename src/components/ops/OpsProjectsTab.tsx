                      ...
                      {colRows.map((r) => {
                        ...
                        >
                          ...
                          <div className="mt-2 flex items-center justify-between gap-2 text-[11px]">
                            <div className={`mt-2 flex items-center gap-1.5 pointer-events-none p-1.5 rounded bg-muted/30 ${r.isLate ? "text-destructive font-medium" : "text-muted-foreground"}`}>
