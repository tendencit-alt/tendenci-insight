                      ...
                      {colRows.map((r) => {
                        const projectSlaTone =
                          r.slaOverdue > 0
                            ...
                            : "";
                        return (
                        <Card key={r.id} className={`p-3 cursor-pointer hover:shadow-md transition ${projectSlaTone}`} onClick={() => setSelectedOrderId(r.id.split('-')[0])}>
            ...
            <Table>
              ...
              <TableBody>
                {loading ? (
                  ...
                  return (
                    <TableRow key={r.id} className="cursor-pointer" onClick={() => setSelectedOrderId(r.id.split('-')[0])}>
