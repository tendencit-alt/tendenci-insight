...
import { Plus, FileText, Calculator, Loader2, Database, Settings2 } from "lucide-react";
import { formatDistanceToNow } from "date-fns";
import { ptBR } from "date-fns/locale";
import { CreateBudgetDialog } from "./CreateBudgetDialog";
import { BudgetEditor } from "./BudgetEditor";
import { BudgetGlobalCostsManager } from "./BudgetGlobalCostsManager";
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        <div className="flex items-center justify-between">
          <TabsList>
            ...
            <TabsTrigger value="custos-base" className="gap-2">
        ...
        <TabsContent value="budgets" className="mt-4">
          <div className="mb-4">
            <p className="text-sm text-muted-foreground">
              Orçamentos técnicos com custos baseados em insumos reais. 
              Altere os <strong>Custos Base</strong> e todos os orçamentos serão recalculados.
            </p>
          </div>
          ...
          {isLoading ? (
            ...
            <div className="grid gap-3">
              {budgets.map(budget => {
                ...
                return (
                  <Card
                    key={budget.id}
                    className="p-4 hover:bg-muted/50 cursor-pointer transition-colors border-l-4 border-l-primary/30 hover:border-l-primary"
                  ...
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div className="text-right">
                        <p className="text-xs text-muted-foreground">Custo Técnico</p>
            ...
            <Card className="p-8 text-center">
              ...
              <p className="text-sm text-muted-foreground mb-4 max-w-md mx-auto">
                Crie orçamentos técnicos baseados em custos reais de materiais, mão de obra e ferragens.
                O custo é calculado automaticamente a partir das linhas técnicas.
              </p>
              <Button onClick={() => setCreateDialogOpen(true)}>
                <Plus className="h-4 w-4 mr-1" />
        ...
        <TabsContent value="custos-base" className="mt-4">
          <BudgetGlobalCostsManager />
        </TabsContent>
      </Tabs>
