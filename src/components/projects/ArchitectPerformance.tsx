    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card className="p-6 space-y-2 border-l-4 border-l-blue-500">
          ...
          <p className="text-xs text-muted-foreground">Média de todos os parceiros profissionais</p>
        </Card>
      </div>
      ...
      {topPerformer && (
        <Card className="p-6 bg-gradient-to-r from-primary/5 to-accent/5 border-l-4 border-l-primary">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div>
              <p className="text-sm text-muted-foreground">Parceiro Profissional</p>
