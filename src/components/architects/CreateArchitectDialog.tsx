...
export function CreateArchitectDialog({ open, onOpenChange, onSuccess }: CreateArchitectDialogProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const validationRules: ValidationRule[] = [
      { field: "name", label: "Nome do Parceiro Profissional", required: true, minLength: 2 },
    ...
    try {
      ...
      toast.success("Parceiro Profissional criado com sucesso!");
      ...
      toast.error("Erro ao criar parceiro profissional", {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="text-2xl">Novo Parceiro Profissional</DialogTitle>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 mt-4">
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-2 col-span-2">
              <Label htmlFor="name">Nome do Parceiro Profissional *</Label>
              <Input
                id="name"
                value={formData.name}
          ...
          <div className="space-y-4 p-4 bg-muted/50 rounded-lg">
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                ...
                <p className="text-sm text-muted-foreground">Marque se este parceiro profissional já teve contato com a empresa</p>
              </div>
              <Switch
                id="ja_contactado"
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-amber-700 dark:text-amber-300">
                    Vincule este parceiro profissional a uma oportunidade existente
                  </p>
                </div>
              </div>
              <Switch
