  ...
  return (
    <TaskBlock
      ...
      actions={[
        ...
        { label: "Comparativos", icon: PieChart, route: "/multi-company", color: "text-sky-600 dark:text-sky-400" },
  ...
  return (
    <TaskBlock
      ...
      actions={[
        ...
        { label: "Benchmarks", icon: PieChart, route: "/multi-company", color: "text-sky-600 dark:text-sky-400" },
