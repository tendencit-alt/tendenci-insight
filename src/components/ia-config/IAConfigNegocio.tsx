  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <EnhancedTextarea
        ...
        placeholder="Quem são seus clientes ideais. Ex: Parceiros Profissionais especificadores, construtoras de médio e grande porte, clientes finais classe A/B que buscam qualidade e personalização..."
        rows={4}
