      ...
      <ModuleShell
        ...
        records={
          <Tabs value={activeTab} onValueChange={setActiveTab}>
            ...
            <TabsContent value="bank_accounts" className="mt-6"><BankAccountsManager /></TabsContent>
            <TabsContent value="chart_accounts" className="mt-6"><ChartAccountsManager /></TabsContent>
            <TabsContent value="cost_centers" className="mt-6"><CostCentersManager /></TabsContent>
            <TabsContent value="projects" className="mt-6"><FinProjectsManager /></TabsContent>
            <TabsContent value="strategic_resource_categories" className="mt-6"><StrategicResourceCategoriesManager /></TabsContent>
            <TabsContent value="responsibles" className="mt-6"><OrderResponsiblesManager /></TabsContent>
            <TabsContent value="card_rates" className="mt-6"><CardRatesManager /></TabsContent>
          </Tabs>
        }
        settings={
          <Tabs defaultValue="origin_rules">
            <TabsList className="flex flex-wrap gap-1">
              <TabsTrigger value="origin_rules" className="gap-2"><Zap className="h-4 w-4" />Automação por Origem</TabsTrigger>
              <TabsTrigger value="event_automations" className="gap-2"><Bot className="h-4 w-4" />Automações por Evento</TabsTrigger>
              <TabsTrigger value="permissions" className="gap-2"><Shield className="h-4 w-4" />Permissões</TabsTrigger>
            </TabsList>
            <TabsContent value="origin_rules" className="mt-6"><OriginRulesMatrix /></TabsContent>
            <TabsContent value="event_automations" className="mt-6"><EventAutomationRulesPanel /></TabsContent>
