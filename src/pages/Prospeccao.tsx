    ...
    <DashboardLayout>
      <div className="space-y-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-3xl font-bold text-foreground">Prospecção de Parceiros Profissionais</h1>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          <TabsList className="bg-card border border-border p-1 h-auto flex-wrap">
            ...
            <TabsTrigger value="crm" className="gap-2 data-[state=active]:bg-primary data-[state=active]:text-primary-foreground">
              ...
              CRM de Parceiros Profissionais
            </TabsTrigger>
        ...
        {/* Sheet para abrir parceiro profissional via evento global - no nível da página */}
        {eventArchitectId && (
