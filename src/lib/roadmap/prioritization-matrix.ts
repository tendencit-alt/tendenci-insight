...
const FASE2_ITEMS: RoadmapItem[] = [
  ...
  { id: "f2-comissoes-avancadas", name: "Comissões avançadas", module: "Comercial", phase: "fase_2", category: "regra",
    fechaFluxoPrincipal: false, geraValorImediato: true, dependeDeOutraBase: true, obrigacaoOuDiferencial: "diferencial",
    description: "Comissões por vendedor, arquiteto, produção com regras e apuração",
    dependencies: ["mvp-pedidos"] },
  ...
  { id: "f2-gestao-arquitetos", name: "Gestão de arquitetos/indicadores", module: "Comercial", phase: "fase_2", category: "entidade",
    fechaFluxoPrincipal: false, geraValorImediato: true, dependeDeOutraBase: true, obrigacaoOuDiferencial: "diferencial",
    description: "Cadastro de arquitetos, indicações, projetos, timeline, comissões",
