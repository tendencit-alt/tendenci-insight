-- Atualizar função RPC para adicionar tolerância de 4 horas
-- Isso evita alertas falsos para tarefas recém-vencidas
  ...
  WHERE d.pipeline_id = p_pipeline_id
    ...
    AND NOT EXISTS (
      ...
      WHERE t.deal_id = d.id
        ...
        AND t.due_at >= NOW() - INTERVAL '4 hours'  -- TOLERÂNCIA: 4 horas após vencimento
    )
