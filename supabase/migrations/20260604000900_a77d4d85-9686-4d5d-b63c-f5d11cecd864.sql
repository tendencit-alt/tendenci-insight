...
BEGIN
  ...
  SELECT jsonb_agg(
    jsonb_build_object(
      ...
      'planned_start_date', COALESCE(o.data_emissao, o.order_updated_at, o.planned_start_date),
      'planned_end_date', o.planned_end_date,
      'actual_start_date', COALESCE(o.actual_start_date, o.data_emissao, o.order_updated_at),
