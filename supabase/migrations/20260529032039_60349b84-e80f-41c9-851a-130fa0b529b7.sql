...
BEGIN
  ...
  -- Tenta extrair parcelas detalhadas da condição de pagamento (JSON em observacao_pagamento)
  ...
  -- Calcula total global de parcelas (para numeração "i/N")
  v_global_total := 0;
      ...
      IF v_parcelas_json IS NOT NULL THEN
        FOR v_parcela IN SELECT * FROM jsonb_array_elements(v_parcelas_json) LOOP
          ...
          FOR v_sub_i IN 1..v_p_subn LOOP
            ...
            VALUES (NEW.client_id, v_sub_amount, v_installment_due, v_competence_date,
