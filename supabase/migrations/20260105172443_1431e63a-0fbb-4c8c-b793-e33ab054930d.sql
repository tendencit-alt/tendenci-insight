-- Atualizar função delete_architect_safely para limpar mais tabelas e adicionar log de auditoria
...
BEGIN
  ...
  INSERT INTO system_errors (title, description, module, severity, source, metadata)
  VALUES (
...
GRANT EXECUTE ON FUNCTION public.delete_architect_safely(uuid) TO authenticated;